...
<a class="text-decoration-none btn bg-087486 text-light" href="<?php echo base_url();?>schema-list/<?php if($selected_id){echo $selected_id;}?>">Next</a>
</div>
</div>
        </div>
    </div>
    ...
    $.ajax({
        ...
        success: function(res) {
            if(res == 'success'){
                ...
                window.location.href = weblink + 'create-job/'+ did + '/' + id;
            }else{
